...
export const AddQuestionPage = () => {
  ...
  const [testCases, setTestCases] = useState<Omit<QuestionTestCase, 'id'>[]>([]);
    ...
    <div className="questions-page">
      ...
      <div className="container-wide" style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div className="questions-header">
          ...
          <p className="subtitle">Create a new interview question for the platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ background: 'white', padding: '2rem', borderRadius: '12px' }}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
              ...
              <button type="button" onClick={addTestCase} style={{ padding: '0.5rem 1rem', background: '#6366f1', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>
                + Add Test Case
              </button>
            </div>
